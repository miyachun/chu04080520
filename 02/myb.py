...
def index():
    print('aa')
    url = 'https://opendata.cwa.gov.tw/api/v1/rest/datastore/F-C0032-001?Authorization=YOURKEY&format=JSON'
    ...
    print(dict_example)
    return render_template('indexmyb.html',dict_example=dict_example)
